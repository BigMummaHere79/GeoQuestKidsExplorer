...
//FXML UI elements
    ...
    //Aaaliyah's Code not mine (Nikki):
    ...
    private String continent = "Antarctica";  // default; set via setContinent(...)
    ...
    private void nextQuestion() {
        ...
        DatabaseManager.CountryQuestion q = dataSource.getRandomCountryByContinent(continent);
