...
public class AfricaFunFacts {

    public static String[][] getalgeriaFacts() {
        return new String[][] {
    ...
    public static  String[][] getangolaFacts() {
        return new String[][]{
    ...
    public static String[][] getbotswanaFacts() {
        return new String[][] {
    ...
    public static String[][] getcentralAfricanRepublicFacts() {
        return new String[][] {
    ...
    public static String[][] getegyptFacts() {
            return new String[][] {
    ...
    public static String[][] geteritreaFacts() {
        return new String[][] {
    ...
    public static String[][] getethiopiaFacts() {
        return new String[][] {
    ...
    public static String[][] getghanaFacts() {
        return new String[][] {
    ...
    public static String[][] getkenyaFacts() {
        return new String[][] {
    ...
    public static String[][] getliberiaFacts() {
        return new String[][] {
    ...
    public static String[][] getlibyaFacts() {
        return new String[][] {
    ...
    public static String[][] getmadagascarFacts() {
        return new String[][] {
    ...
    public static String[][] getmauritiusFacts() {
        return new String[][] {
    ...
    public static String[][] getmoroccoFacts() {
        return new String[][] {
    ...
    public static String[][] getnigeriaFacts() {
        return new String[][] {
    ...
    public static String[][] getsomaliaFacts() {
        return new String[][] {
    ...
    public static String[][] getsouthAfricaFacts() {
        return new String[][] {
    ...
    public static String[][] getsouthSudanFacts() {
        return new String[][] {
    ...
    public static String[][] gettanzaniaFacts() {
        return new String[][] {
    ...
    public static String[][] gettunisiaFacts() {
        return new String[][] {
    ...
    public static String[][] getugandaFacts() {
        return new  String[][] {
    ...
    public static String[][] getzambiaFacts() {
        return new  String[][] {
    ...
    public static String[][] getzimbabweFacts() {
        return new String[][] {
