...
class AntarticaQuizDataTest {

    @Test
    void testIfCorrectAnswerIsNotNull(){
        //Get the practise quesations from conttroller and store it in list questions
    ...
    void countryCodeIsValid(){
        //Get the practise quesations from controller and store it in list questions
        List<QuizQuestions> questions = AntarcticaQuizData.getPracticeQuestions();
